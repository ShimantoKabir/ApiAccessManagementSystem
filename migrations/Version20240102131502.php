 ...
 */
final class Version20240102131502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alliances_actions (alliance_id INT NOT NULL, action_id INT NOT NULL, INDEX IDX_B77D1CFA10A0EA3F (alliance_id), INDEX IDX_B77D1CFA9D32F035 (action_id), PRIMARY KEY(alliance_id, action_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
